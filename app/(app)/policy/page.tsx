  ...
  return (
    <article className="mx-auto max-w-4xl space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-sm text-slate-600">End in Mind Inc.</p>
      </header>
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-slate-700">
          ...
          <li>Contributions made by End in Mind Inc. are tax-deductible business expenses.</li>
        </ul>
      </section>
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6">
        ...
        <p className="mt-2 text-slate-700">
          This policy is reviewed annually and may be updated at End in Mind Inc.’s discretion. Employees will be
