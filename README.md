# End In Mind Capital HSA Portal (MVP)

Internal web portal for End In Mind Capital Inc. to manage HSA claims with secure Clerk authentication, role-based access control, claim submission/review workflows, annual balance tracking, and audit logging.
